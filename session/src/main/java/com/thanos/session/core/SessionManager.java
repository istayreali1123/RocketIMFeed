...
import com.thanos.session.cache.RedisCache;
...
public class SessionManager extends ManagerBase implements Lifecycle {
    ...
    protected ThreadLocal<SessionContext> sessionContext = new ThreadLocal<SessionContext>();

    protected SessionHandlerValue handlerValve;
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        for (Valve valve : context.getPipeline().getValves()) {
            if (valve instanceof SessionHandlerValue) {
                this.handlerValve = (SessionHandlerValue) valve;
    ...
    public void save(org.apache.catalina.Session session, boolean forceSave) {
        try {
            ...
            byte[] hash = (this.sessionContext.get() != null && this.sessionContext.get().getMetadata() != null)
                    ? this.sessionContext.get().getMetadata().getAttributeHash() : null;
            ...
            if (forceSave || newSession.isDirty()
                ...
                metadata.setAttributeHash(currentHash);
